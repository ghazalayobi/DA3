...
boxplot_edu_gender <- ggplot(dt, aes(x = grade92, y = w, fill = factor(gender), color=factor(gender))) +
...
```{r echo=FALSE}
#grid.arrange(boxplot_edu, boxplot_edu_gender, ncol = 2)
...
#grid.arrange(scatter_age, scatter_edu, ncol = 2)
