...
m4 <- as.formula(w ~ ed_associate + ed_BA + ed_MA + ed_Profess + ed_PhD + age + agesq + female + privt_sec + marital_status + ed_associate *female  + emale * ed_BA +  + female * ed_MA + female * ed_Profess + female * ed_PhD + female * age + female * agesq + female * privt_sec + female * child)
