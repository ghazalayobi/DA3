...
dt <- dt[grade92 == 43, educ := "Bachelors"][grade92 == 44, educ := "Masters"][grade92 == 45, educ := "Professional"][grade92 == 46, educ := "PhD"]

dt <- dt[sex == 1, gender := "Male"][sex == 2, gender := "Female"]



datasummary(as.factor(grade92)*as.factor(sex) ~ N, data = dt)
...
boxplot_class_gender <- ggplot(dt, aes(x = factor(class), y = w, fill = factor(gender), color=factor(gender))) +
  ...
  scale_x_discrete(labels = c("Gov-", "Yes"))
